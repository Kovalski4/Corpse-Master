...
public class NMSCorpse_v1_16_R1 implements ICorpse {
    ...
    public NMSCorpse_v1_16_R1(Location location, Player player, boolean hookEquipment){
    ...
    public void sendEquipmentPacket(Player player) {
        ...
        net.minecraft.server.v1_16_R1.ItemStack helmet = CraftItemStack.asNMSCopy(owner.getInventory().getHelmet());
        net.minecraft.server.v1_16_R1.ItemStack chestplate = CraftItemStack.asNMSCopy(owner.getInventory().getChestplate());
        net.minecraft.server.v1_16_R1.ItemStack leggings = CraftItemStack.asNMSCopy(owner.getInventory().getLeggings());
        net.minecraft.server.v1_16_R1.ItemStack boots = CraftItemStack.asNMSCopy(owner.getInventory().getBoots());

        Pair<EnumItemSlot, net.minecraft.server.v1_16_R1.ItemStack> pair = new Pair<>(EnumItemSlot.HEAD, helmet);
        Pair<EnumItemSlot, net.minecraft.server.v1_16_R1.ItemStack> pair2 = new Pair<>(EnumItemSlot.CHEST, chestplate);
        Pair<EnumItemSlot, net.minecraft.server.v1_16_R1.ItemStack> pair3 = new Pair<>(EnumItemSlot.LEGS, leggings);
        Pair<EnumItemSlot, net.minecraft.server.v1_16_R1.ItemStack> pair4 = new Pair<>(EnumItemSlot.FEET, boots);
